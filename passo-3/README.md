...
O arquivo `ApresentacaoRuim.cs` demonstra exatamente isso.

## 🧪 Momento de Teste

1. Adicione o código de `ApresentacaoRuim.cs` ao seu ambiente online.
2. Atualize o `Program.cs` para chamar a execução deste cenário.
3. Clique em **Run**.

**Resultado Esperado:** 
O sistema **terminará com sucesso** (sem quebrar), exibindo apenas a sua mensagem: `"❌ [RUIM] Ops! Ocorreu um erro na operação."`
